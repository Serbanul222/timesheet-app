    ...
    return (
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-gray-900">Verifică-ți emailul</h1>
          <p className="mt-2 text-sm text-gray-600">
            Am trimis un email la adresa:
          </p>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
          <p className="text-sm text-blue-700">
           Dacă nu primiți emailul, verificați folderul de spam sau încercați să trimiteți din nou. Link-ul exipiră într-o oră.
          </p>
        </div>
  ...
  return (
    <div className="w-full max-w-md space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        >
          {isSubmitting ? 'Trimitere...' : 'Trimite linkul de resetare'}
        </button>
