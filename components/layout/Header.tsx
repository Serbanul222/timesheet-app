...
export function Header({ className = '' }: HeaderProps) {
  ...
  // Navigation items based on user permissions (like a menu configuration in Java)
                    ...
                    <div className="border-t border-gray-100 pt-1">
                      <div className="px-4 py-2">
                        <LogoutButton 
                          variant="ghost" 
                          size="sm"
                          className="w-full justify-start h-auto p-0 text-gray-700 hover:text-red-600"
                          showConfirmation
                        />
                      </div>
                    </div>
...
// Helper function to get user-friendly role names (like a toString() method in Java)
